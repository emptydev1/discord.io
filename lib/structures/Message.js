...
const MessageFlagsBits = require("../helpers/MessageFlagsBits");
 ...
 * @prop {Application} application Sent with Rich Presence-related chat embeds
 ...
 * @prop {MessageFlagsBits} flags Message flags combined as bitfield
...
class Message extends Base {
    ...
    _patch(data) {
        ...
        this.mentions = new Mentions(this.client, data);
 ...
            };
        ...
        if ('flags' in data) {
            this.flags = new MessageFlagsBits(data.flags);
        } else {
            this.flags ??= null;
        }
    ...
    /**
     * Returns an object with the channel used to sent message
     * @readonly
     */
    get channel() {
    ...
    /**
     * Returns an object with the current guild
     * @readonly
     */
    get guild() {
     ...
     */
    async delete() {
        await this.client.rest.delete(Routes.channelMessage(this.channelId, this.id), {}, false);
    }
}
