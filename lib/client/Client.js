...
class Client extends EventEmmiter {
     ...
     * @arg {Object | String} [body] The body of the message
     * @arg {String} [body.content] A string with the message content
     */
    createMessage(channelId, body) {
        if (!this.token) throw new Error("Client token not set");
        if (!channelId || !body) throw new TypeError("Missing channel ID and body");
